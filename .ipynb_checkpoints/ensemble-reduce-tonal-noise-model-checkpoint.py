...
pos_file['mean-pos'] = detections_pos[mean_cols_pos].mean(axis=1)
neg_file['mean-neg'] = detections_neg[mean_cols_neg].mean(axis=1)

merge_df = pos_file[['filename', 'start', 'end', 'mean-pos']].copy()
merge_df['mean-neg'] = neg_file['mean-neg']
